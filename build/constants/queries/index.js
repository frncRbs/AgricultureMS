...
var adminQueries = {
  QUERY_INSERT_FULL_DETAILED_USER_ACCOUNT: 'QUERY_INSERT_FULL_DETAILED_USER_ACCOUNT'
};
var tokenQueries = {
...
module.exports = _objectSpread(_objectSpread(_objectSpread({}, authQueries), adminQueries), tokenQueries);